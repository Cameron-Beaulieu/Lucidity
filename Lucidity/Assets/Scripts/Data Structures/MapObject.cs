...
public class MapObject
{
    ...
    /// A <c>boolean</c> representing whether or not the asset is visible on the map.
    /// </param>
    public MapObject(int id, string name, int prefabIndex, Vector2 mapPosition, Vector2 mapOffset,
                      Vector3 scale, Quaternion rotation, bool isActive, bool isVisible) {
        Id = id;
        Name = name;
    ...
    /// <summary>
    /// Alternate MapObject constructor, initializing an additional GameObject object to <c>MapObject</c>
    /// </summary>
    /// <param name="id">
    /// ID used as a key within the MapObject dictionary within MapEditorManager
    /// </param>
    ...
    /// </param>
    /// <param name="gameObj">
    /// A <c>GameObject</c> object that is connected to the MapObject.
    /// </param>
    public MapObject(int id, string name, int prefabIndex, Vector2 mapPosition, Vector2 mapOffset,
                     Vector3 scale, Quaternion rotation, bool isActive, bool isVisible, GameObject gameObj) {
        Id = id;
        Name = name;
        PrefabIndex = prefabIndex;
        MapPosition = mapPosition;
